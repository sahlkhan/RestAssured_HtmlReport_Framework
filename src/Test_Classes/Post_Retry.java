...
public class Post_Retry {
	...
	public static void Extractor() throws IOException {
		...
		for (int i = 0; i < 5; i++) {
			int statuscode = Api_Methods.ResponseStatusCode(Post_Req_Repositry.BaseURI(),
					Post_Req_Repositry.Post_Resourse(), Post_Req_Repositry.Post_Reg_TC1());
			System.out.println(statuscode);
			if (statuscode == 201) {
				String ResponseBody = Api_Methods.ResponseBody(Post_Req_Repositry.BaseURI(),
						Post_Req_Repositry.Post_Resourse(), Post_Req_Repositry.Post_Reg_TC1());
